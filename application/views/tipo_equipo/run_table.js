$(document).ready(function() {
    ...
    var table =$('#tab').DataTable( {
        ...
        "processing": true,
        "ajax": {
            "url": base_url+"tipo_equipo/cargar_datos/",
            "type": "POST"
        },
        "columns": [
            { "data": "tipequ_id" },
            { "data": "tipequ_descripcion" },            
    ...
    $('#tab tbody').on('click', 'td.editar-data', function () { //Agregar los datos correspondientes al modal-form
        ...
        $("#id").val(row.data().tipequ_id);
        $("#descripcion").val(row.data().tipequ_descripcion);
        $("#abreviatura").val(row.data().tipequ_abreviatura);
    ...
    $('#tab tbody').on('click', 'td.eliminar-data', function () { //Agregar los datos correspondientes al modal-delete
        ...
        $("#id_dato_eliminar").val(row.data().tipequ_id);
        $('#desc_dato_eliminar').html(row.data().tipequ_descripcion);
