    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-user"></i> Formulario Usuario</h4>
            </div>
            <form role="form" action="" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" required class="form-control" id="name" name="name" placeholder="Ingrese descripcion" onkeypress="return soloLetras(event)">
                    </div>
                    <div class="form-group">
                        <label for="descripcion">Password</label>
                        <input type="password" required class="form-control" id="password" name="password" placeholder="Ingrese password" ">
                    </div>
                </div>
